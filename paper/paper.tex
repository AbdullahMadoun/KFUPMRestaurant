...
labels $4{,}999$ trays once offline (Qwen2.5-VL-72B-AWQ\,$\rightarrow$\,SAM3\,$\rightarrow$\,DINOv2/SigLIP cluster
...
\S\ref{sec:student}).} A Qwen2.5-VL-72B-AWQ teacher labels 4{,}999 cafeteria
images via a structured-JSON prompt, followed by SAM3 segmentation, DINOv2 +
SigLIP clustering, and human cluster curation. The resulting 4{,}629-item
...
\input{sections/03_data_engine.tex}

%-----------------------------------------------------------------------------
\section{Student Pipeline: TahamajaNet Inference}
\label{sec:student}

\input{sections/04_student.tex}

%-----------------------------------------------------------------------------
\section{Cardinality-Aware Fine-Tuning}
\label{sec:cardinality}

\input{sections/05_cardinality.tex}

%-----------------------------------------------------------------------------
\section{Dish-Correct: An End-to-End Semantic Metric}
\label{sec:metric}

\input{sections/06_metric.tex}
